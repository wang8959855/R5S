...
- (id)init {
    ...
    return [self initWithVC:nil image:[UIImage imageNamed:@""] selectedImage:@"" andTitle:@""];
}

- (id)initWithVC:(UIViewController *)vc image:(UIImage *)image selectedImage:(UIImage *)selectedImage andTitle:(NSString *)title
{
