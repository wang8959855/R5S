...
@protocol HeartRateCircleViewDelegate;

IB_DESIGNABLE

@interface HeartRateCircleView : UIView
 ...
 */
@property (nonatomic, weak) IBOutlet id<HeartRateCircleViewDelegate> delegate;
...
@protocol HeartRateCircleViewDelegate <NSObject>

@optional
/*!
 *  Return ring stroke color from the specified value.
 */
- (UIColor *)gaugeView:(HeartRateCircleView *)gaugeView ringStokeColorForValue:(CGFloat)value;
