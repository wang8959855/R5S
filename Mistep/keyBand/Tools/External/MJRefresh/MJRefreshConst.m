...
//NSString *const MJRefreshHeaderPullToRefresh = @"下拉可以同步数据";
//NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即同步数据";
//NSString *const MJRefreshHeaderRefreshing = @"正在同步数据...";
