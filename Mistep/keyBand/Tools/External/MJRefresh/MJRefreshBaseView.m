...
- (UILabel *)statusLabel
{
    if (!_statusLabel) {
        ...
        statusLabel.textColor = [UIColor clearColor];
...
- (void)setPullToRefreshText:(NSString *)pullToRefreshText
{
    ...
    //    _pullToRefreshText = NSLocalizedString(@"下拉可以刷新", nil);
    _pullToRefreshText = NSLocalizedString(@"下拉可以同步数据", nil);
...
- (void)setReleaseToRefreshText:(NSString *)releaseToRefreshText
{
    ...
    //    _releaseToRefreshText = NSLocalizedString(@"松开立即刷新", nil);
    _releaseToRefreshText = NSLocalizedString(@"松开立即同步数据", nil);
    [self settingLabelText];
}
- (void)setRefreshingText:(NSString *)refreshingText
{
    //    _refreshingText = [refreshingText copy];
    //    _refreshingText = NSLocalizedString(@"正在刷新数据...", nil);
    _refreshingText = NSLocalizedString(@"正在同步数据...", nil);
    [self settingLabelText];
}
