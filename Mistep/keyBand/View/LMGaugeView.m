...
- (void)strokeGauge
{
     ...
     */
//    UIColor *ringColor = kColor(0, 160, 233);
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (!self.sportImage) {
        ...
        self.sportImage.contentMode = UIViewContentModeScaleAspectFit;
        self.sportImage.image = [UIImage imageNamed:@"newbushu"];
        self.sportImage.size = CGSizeMake(48 , 29);
        self.sportImage.center = CGPointMake(self.width/2, self.height/2-48);
        [self addSubview:self.sportImage];
    }
    ...
    if (!self.valueLabel)
    {
        ...
        self.valueLabel.textColor = allColorWhite;
    ...
    if (!self.comLabel)
    {
        ...
        self.comLabel.textColor = allColorWhite;
